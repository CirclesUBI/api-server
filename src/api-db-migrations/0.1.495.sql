...
--
-- Name: idx_deinemudda; Type: INDEX; Schema: public; Owner: doadmin
--
CREATE INDEX idx_deinemudda ON public.i18n USING btree (((key || lang)));
...
insert into db_version (version, description) values ('0.1.495', 'The initial release-db');