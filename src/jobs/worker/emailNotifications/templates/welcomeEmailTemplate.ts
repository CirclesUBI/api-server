...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml">
  ...
  <head>
    ...
    <![endif]-->
    <title>Welcome to Circles Land</title>
    <style>
      @font-face {
  ...
  <body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; height: 100%; background-color: #e5e7eb; font-family: 'Poppins', ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; color: #0a2262;">
    <div style="z-index: 50; width: 100%;">
      <div style="margin-left: auto; margin-right: auto; display: grid; width: 100%; grid-template-columns: repeat(3, minmax(0, 1fr)); justify-items: stretch; background-color: #081b4a; padding: 5px 5px 5px 10px; color: #ffffff;">
        ...
        <div style="grid-column-start: 3; margin-right: 20px; place-self: center; justify-self: end;">
          <div style="align-self: center; text-align: center;">
            <a href="https://circles.land/" style="text-decoration: none; color: inherit;">Log in</a>
          </div>
        </div>
      </div>
    </div>
    <div role="article" aria-roledescription="email" aria-label="Welcome to Circles Land" lang="en">
            ...
            <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
              <tr>
                <td style="text-align: center;">
                  <header style="display: grid; height: 60px; place-content: center; overflow: hidden; background-image: linear-gradient(to right, var(--tw-gradient-stops)); --tw-gradient-from: #1dd6a4; --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to, rgba(29, 214, 164, 0)); --tw-gradient-to: #41c7f1; background-size: cover; padding-top: 52px; padding-bottom: 52px; color: #ffffff;">
                    <div style="display: block; align-self: center; text-align: center;">
                      <span style="display: inline-block; font-family: 'Ostrich Sans Heavy', 'Nunito', ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; font-size: 36px; text-transform: uppercase; letter-spacing: -0.05em;">Welcome - You made it!</span>
                    </div>
                  </header>
                </td>
              </tr>
                  ...
                  <table class="sm-w-full" style="width: 75%;" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="background-color: #ffffff; padding: 48px;">
                        <p style="margin: 0; text-align: center; font-family: 'Poppins', ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; font-size: 24px; font-weight: 700;">
                        ...
                        <p style="font-size: 16px; color: #0a2262;">
                          ...
                          <br><br>
                          <b>Where:</b> <br/><b style="font-size: 24px;">Alte Utting</b> <br/>Lagerhausstraße 15<br/> 81371 München
                          <br>Unterdeck im Maschinenraum
                          <br/>
                          <br>
                          <b>When:</b> <br/>19th of March 2022, starting at 3 pm
                          <br><br>
                        ...
                        <div style="text-align: center;">
                          <a href="{{loginUrl}}" class="hover-bg-primary-dark" style="display: inline-block; border-radius: 8px; background-color: #41c7f1; padding: 20px 24px; font-size: 14px; font-weight: 600; text-transform: uppercase; line-height: 1; color: #ffffff; text-decoration: none;">
                            <!--[if mso
                                ...
                                >&nbsp;</i><!
                            [endif]-->
                            <span style="mso-text-raise: 13pt">Log in now &rarr;</span>
                            <!--[if mso
                              ]><i
                                style="
                                  letter-spacing: 24px;
                        ...
                        <div class="sm-h-24" style="line-height: 24px;">&zwnj;</div>
                        <div style="line-height: 5px;">&zwnj;</div>
                        <div style="line-height: 5px;">&zwnj;</div>
                      </td>
                    </tr>
                    <tr>
