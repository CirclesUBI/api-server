                ...
                <td style="padding-top: 28px; text-align: center;">
                  <header style="margin-top: 12px; display: grid; height: 60px; place-content: center; overflow: hidden; background-image: linear-gradient(to right, var(--tw-gradient-stops)); --tw-gradient-from: #1dd6a4; --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to, rgba(29, 214, 164, 0)); --tw-gradient-to: #41c7f1; background-size: cover; padding-top: 52px; padding-bottom: 52px; color: #ffffff;">
                    <div style="display: block; align-self: center; text-align: center;">
                      <span style="display: inline-block; font-family: 'Ostrich Sans Heavy', 'Nunito', ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; font-size: 36px; text-transform: uppercase; letter-spacing: -0.05em;">Verify Your Email Address</span>
                    </div>
                  </header>
                </td>
              </tr>
                    ...
                    <tr>
                      <td class="sm-px-24" style="background-color: #ffffff; padding: 48px; text-align: center;">
                        ...
                        <p style="font-size: 16px; color: #0a2262;">
                          To verify this email address simply click the button
                          below.
                          <br>
                          <br>
                          Once verified we will notify you when you receive
                          money or have new incoming trusts through circles.land
                        </p>
                        ...
                        <a href="{{confirmUrl}}" class="hover-bg-primary-dark" style="display: inline-block; border-radius: 8px; background-color: #41c7f1; padding: 20px 24px; font-size: 14px; font-weight: 600; text-transform: uppercase; line-height: 1; color: #ffffff; text-decoration: none;">
                          <!--[if mso
                            ...
                            >&nbsp;</i><!
                        [endif]-->
                          <span style="mso-text-raise: 13pt">Verify Email Address &rarr;</span>
                          <!--[if mso
                          ]><i
