...
// Fields: confirmUrl
export const verifyEmailAddressEmailTemplate: MailTemplate = {
...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml">
  ...
  <body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; height: 100%; background-color: #e5e7eb; font-family: 'Poppins', ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; color: #0a2262;">
    ...
    <div role="article" aria-roledescription="email" aria-label="Confirm Email" lang="en">
                ...
                <td style="text-align: center;">
                  <header style="display: grid; height: 60px; place-content: center; overflow: hidden; background-image: linear-gradient(to right, var(--tw-gradient-stops)); --tw-gradient-from: #1dd6a4; --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to, rgba(29, 214, 164, 0)); --tw-gradient-to: #41c7f1; background-size: cover; padding-top: 52px; padding-bottom: 52px; color: #ffffff;">
                    <div style="display: block; align-self: center; text-align: center;">
                      <span style="display: inline-block; font-family: 'Ostrich Sans Heavy', 'Nunito', ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; font-size: 36px; text-transform: uppercase; letter-spacing: -0.05em;">Confirm your Email address</span>
                    </div>
                  </header>
                </td>
              </tr>
                  ...
                  <table class="sm-w-full" style="width: 75%;" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="background-color: #ffffff; padding: 48px; text-align: center;">
                        <p style="margin: 0; font-size: 18px; font-weight: 600;">Hi,</p>
                        ...
                        <a href="undefined" class="hover-bg-primary-dark" style="display: inline-block; border-radius: 8px; background-color: #41c7f1; padding: 20px 24px; font-size: 14px; font-weight: 600; text-transform: uppercase; line-height: 1; color: #ffffff; text-decoration: none;">
                          <!--[if mso
                            ...
                            >&nbsp;</i><!
                        [endif]-->
                          <span style="mso-text-raise: 13pt">Confirm Email Address &rarr;</span>
                          <!--[if mso
                          ]><i
