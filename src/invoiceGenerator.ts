...
function generateCustomerInformation(doc:(typeof PDFDocument), invoice: {
  buyer: {name: string, address:string, postal_code: string, city: string, country: string, safe_address: string},
  seller: {name: string, address:string, postal_code: string, city: string, country: string, safe_address: string}
}) {
...
function generateSubtotalTable(doc:(typeof PDFDocument), invoice: {
...
function generateTransactionMetaData(doc:(typeof PDFDocument), invoice: {transferTime: string, transactionHash: string}) {
  top += 40;
  newPageCheck(doc, invoice);
...
function generateInvoiceTable(doc:(typeof PDFDocument), invoice: {
  items: {
    amount: number
